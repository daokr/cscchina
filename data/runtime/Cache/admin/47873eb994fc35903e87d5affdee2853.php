...
<!--main-->
<div class="midder">
<h2 style="height:28px;"><span><a href="<?php echo U('content/addyear');?>">+添加年份</a></span><?php echo ($title); ?></h2>  
...
<?php if(is_array($years)): foreach($years as $key=>$item): ?><tr class="odd">
<td><?php echo ($item[yearid]); ?></td>
<td><?php echo ($item[yearname]); ?></td>
<td><a href="<?php echo U('content/edityear',array('yearid'=>$item[yearid]));?>">[编辑]</a> </td>
