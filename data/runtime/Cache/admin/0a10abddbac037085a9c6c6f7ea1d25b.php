...
<div class="Toolbar_inbox">
	<a class="btn_a" href="<?php echo U('prize/addfocus');?>"><span>添加新焦点图</span></a>
</div>
...
<td>
<a href="<?php echo U('prize/editfocus',array('id'=>$item[id]));?>">[编辑]</a>&nbsp;&nbsp;
<a href="<?php echo U('prize/delfocus',array('id'=>$item[id]));?>">[删除]</a>
</td>
