...
<table cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td><?php echo ($cateid); ?>
            <select name="cateid">
            <?php if(is_array($arrCate)): foreach($arrCate as $key=>$item): if($item[cateid] == $strArt[cateid]): ?><option value="<?php echo ($item[cateid]); ?>" selected="selected"><?php echo ($item[catename]); ?></option>
                <?php else: ?>
