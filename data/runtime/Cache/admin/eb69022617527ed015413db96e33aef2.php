...
<form method="POST" action="<?php echo U('content/edityear',array('yearid'=>$str[yearid]));?>" id="formMini" >
<table cellpadding="0" cellspacing="0">
	<tr>
		<th>年份：</th>
		<td><input name="yearname" value="<?php echo ($str[yearname]); ?>" style="width:200px"/>年 如：2012 只能填写数字</td>
	</tr>   
