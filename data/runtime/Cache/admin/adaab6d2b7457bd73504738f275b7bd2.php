...
<script type="text/javascript">
	var objdata = {'type': 'company'};
	var jumpurl = "<?php echo U('forum/medias');?>";
...
{		
	$("#uploadify").uploadify({
		...
		'script': 'index.php?g=admin&m=forum&a=ajaxupload',
		'scriptData':objdata,
		'method':'POST', 
...
<h2><?php echo ($title); ?></h2>
	...
	<?php if($type != 'n'): ?><div class="uploadtype">
                ...
                <p><br>无法上传？<a href="<?php echo U('forum/addmedias',array('type'=>'n'));?>">使用普通方式上传照片&gt;</a></p>
       		</div>
        <?php else: ?> 
            <div class="uploadtype">
                <p class="pl">你可以上传JPG，JPEG， GIF，PNG，每个文件大小可以到1M。</p><br>
                <form enctype="multipart/form-data" action="<?php echo U('forum/addmedias',array('type'=>'n'));?>" method="post" name="album_upload">
                ...
                <p><br><a href="<?php echo U('forum/addmedias');?>">使用批量上传方式上传照片&gt;</a></p>      
            </div><?php endif; ?>
