...
<form method="POST" action="<?php echo U('content/addarticle');?>" id="formMini" onsubmit="return miniSubmit(this)">
<table cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td>
            <select name="yearid">
            <?php if(is_array($years)): foreach($years as $key=>$item): if($item[yearid] == $yearid): ?><option value="<?php echo ($item[yearid]); ?>" selected="selected"><?php echo ($item[yearname]); ?></option>
                <?php else: ?>
	...
	<tr>
		...
		<td>
            <select name="cateid">
            <?php if(is_array($cates)): foreach($cates as $key=>$item): if($item[cateid] == $cateid): ?><option value="<?php echo ($item[cateid]); ?>" selected="selected"><?php echo ($item[catename]); ?></option>
                <?php else: ?>
